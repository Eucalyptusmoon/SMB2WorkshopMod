...
void init_sel_ngc() {
    ...
    patch::write_word(relutil::relocate_addr(0x808ff800), PPC_INSTR_LI(PPC_R0, (main_game_bitflag + 0x4)));
    patch::write_word(relutil::relocate_addr(0x808ff80c), PPC_INSTR_LI(PPC_R0, (main_game_bitflag)));
