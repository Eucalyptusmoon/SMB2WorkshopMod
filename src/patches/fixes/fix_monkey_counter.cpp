...
void init_main_loop() {
    patch::write_word(relutil::relocate_addr(0x80332874), PPC_INSTR_CMPWI(PPC_R0, 255));
    patch::write_word(relutil::relocate_addr(0x80332f94), PPC_INSTR_CMPWI(PPC_R0, 255));
}
